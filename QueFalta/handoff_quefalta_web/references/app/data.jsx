// data.jsx — app content for LaCompra mockups (extracted from the codebase)
const USER = { name: 'Rubén', initials: 'RU' };
...
Object.assign(window, { USER, MEMBERS, GROUPS, CATEGORIES, LIST_ITEMS, PRODUCTS, euro });
