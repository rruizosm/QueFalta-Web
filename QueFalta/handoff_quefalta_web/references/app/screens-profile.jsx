// screens-profile.jsx — Perfil de usuario (token-driven; works in any theme/tweaks).
// Exports: ProfileBody, ProfileScreen, ProfileToggle
const EditOpenCtx = React.createContext(() => {});

function ProfileToggle({ on }) {
  const t = useTk();
  return (
    <div style={{
...
function ProfileBody() {
  ...
  return (
    <div style={{ padding: `${t.sp(6)}px ${screenPad(t)}px ${t.sp(16)}px` }}>
      ...
      <MenuRow icon="info" label="Acerca de LaCompra" value="v2.0" last />
...
Object.assign(window, { ProfileBody, ProfileScreen, ProfileToggle, EditOpenCtx });
