// Landing.jsx — landing de marketing de QueFalta (isla React).
// Reutiliza los mockups de pantallas de la app (tema "Mercado Fresco").
...
import { ProfileScreen } from '../phone/screens/Profile.jsx';

// Sustituir por la URL real de la ficha en la App Store cuando exista.
const APP_STORE_URL = '#';

// ── Features: una pantalla del teléfono por bloque de scroll ───
const FEATURES = [
  {
